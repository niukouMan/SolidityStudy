...
import com.example.demo.dto.EthRawTransaction;
...
public class EthInvoke {
    ...
    public CompletableFuture<EthCall> callSimpleContractInfo(String contractAddress, String methodName) {
        ...
        Transaction ethCallTransaction = Transaction.createEthCallTransaction(DEFAULT_WALLET_ADDRESS, contractAddress, encode);
        try {
